...
<div id="navBar">
    <form class="pure-form" action="UserController" method="Post">
        <table class="style1">
            <tr>
                    ...
                    <table height="20" cellpadding="0" cellspacing="0" border="0" width="300px">
                        <tr>
                            <td width="40%" align="center" class="styleTextCart">
                                <a href="addNewProduct.jsp" style="font-weight: bold; text-decoration: none; color: #CCCCCC;
                                   font-size: small">Add new product
                                </a>
                            </td>
                            <td width="40%" align="center" class="styleTextCart">

                                <input type="submit" name="action" value="PrintPDF">
                            </td>
